...
bot.on('callback_query', async (query) => {
  ...
  else if (data === "placeholder_stex" || data === "placeholder_mk") bot.answerCallbackQuery(query.id, { text: "🛠 This logic has not been integrated yet.", show_alert: true });
  else if (data === "placeholder_ig" || data === "placeholder_wa") bot.answerCallbackQuery(query.id, { text: "🛠 This service is not available yet.", show_alert: true });
